...
class ChildRecyclerViewAdapter(private var mList: List<ChildItem>) :
    RecyclerView.Adapter<ChildRecyclerViewAdapter.LanguageViewHolder>() {
    ...
    fun setFilteredList(mList: List<ChildItem>) {
        this.mList = mList
    ...
    override fun onBindViewHolder(holder: LanguageViewHolder, position: Int) {
        ...
        holder.logo.setImageResource(languageData.image)
